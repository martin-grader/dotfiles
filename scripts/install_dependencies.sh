...
echo "installing vim"
sudo apt --assume-yes install vim >> $log_file 2>&1
echo "installing tmux"
sudo apt-get --assume-yes install tmux >> $log_file 2>&1
echo "installing fzf"
sudo apt --assume-yes install fzf >> $log_file 2>&1
echo "installing curl"
sudo apt --assume-yes install curl >> $log_file 2>&1
echo "installing zsh"
sudo apt --assume-yes install zsh >> $log_file 2>&1
...
echo "installing pip"
sudo apt --assume-yes install pip >> $log_file 2>&1
echo "installing pipx"
sudo apt --assume-yes install pipx >> $log_file 2>&1
...
sudo apt --assume-yes install nodejs >> $log_file 2>&1
echo "installing npm"
sudo apt --assume-yes install npm >> $log_file 2>&1
